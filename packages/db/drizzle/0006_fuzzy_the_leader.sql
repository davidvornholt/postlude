CREATE TABLE "entry_search_evidence" (
	...
	CONSTRAINT "entry_search_evidence_range" CHECK ("entry_search_evidence"."match_start" >= 0 and "entry_search_evidence"."match_length" >= 1 and "entry_search_evidence"."anchor_length" >= 1 and "entry_search_evidence"."anchor_length" <= "entry_search_evidence"."match_length" and "entry_search_evidence"."match_start" + "entry_search_evidence"."match_length" <= char_length("entry_search_evidence"."excerpt"))
);
